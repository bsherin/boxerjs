...
class MainApp extends React.Component {
    ...
    render() {
        return React.createElement(DataBox, { data_object: this.props.data });
    }
}
        ...
        let the_content = this.props.data_object.content.map((item, index) => {
            if (isString(item)) {
                return (
                    ...
                    React.createElement(ContentEditable, { className: 'editable',
                        tagName: 'div',
                        key: index,
                        disabled: false,
                ...
                return React.createElement(DataBox, { key: index, data_object: item });
            }
        });
        return the_content;
    }
