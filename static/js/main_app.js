...
class MainApp extends React.Component {
    ...
    _getMatchingNode(uid, node) {
        ...
        if (node.kind == "text" || node.kind == "jsbox" || node.kind == "turtlebox" || node.kind == "p5turtlebox" || node.kind == "pixiturtlebox" || node.line_list.length == 0) {
            return false;
        }
    ...
    _copyBoxerSelection() {
        ...
        if (select_parent_node.kind == "line") {
            ...
            let copied_lines = selec_parent_node.line_list.slice(this.state.select_range[0], this.state.select_range[1] + 1);
