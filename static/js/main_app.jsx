...
class MainApp extends React.Component {
    ...
    _insertClipboard(text_id, cursor_position, new_base=null, update=true) {
        ...
        if (updated_lines.length == 1) {
            ...
            this._insertNodes(updated_lines[0].node_list, targetLine.unique_id,
                targetLine.node_list.length, new_base, false, true);
            ...
            this._insertNodes(_.last(updated_lines).node_list, targetLine2.unique_id,
                0, new_base, false, true);
