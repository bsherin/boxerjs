...
import {createNode, newClosetLine, newDataBoxNode, newLineNode, newTextNode, nodeModels} from "./node_creator_actions.js";
import {
    changeNode,
    changeNodeMulti,
    createEntry,
...
import {
    ...
    cloneLineToStore,
    cloneNodeToStore, createCloset, focusName,
    healLine,
    healStructure, positionAfterBox, setFocus,
    setLineList,
    setPortTarget,
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators({ newTextNode, newLineNode, newDataBoxNode, newClosetLine, createNode, nodeModels,
      createEntry, changeNodeMulti, changeNode, setNodeDict, insertNode, insertNodes, insertLine,
    replaceNode, replaceLine, removeNode, removeLine, setGlobal, storeFocus,
      ...
      setFocus, positionAfterBox, zoomBox, unzoomBox, focusName, addGraphicsComponent, toggleBoxTransparency,
